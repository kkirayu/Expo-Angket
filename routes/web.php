...
Route::post('/angket/store', [JawabanController::class, 'angketStore'])->name('angket.store');
...
Route::middleware('auth')->group(function () {
    ...
    // Route Admin Jawaban
    Route::resource('admin-jawaban', JawabanController::class);
    Route::get('/admin-jawaban/{slug}/acara', [JawabanController::class, 'jawabanAcara'])->name('admin.jawaban-acara');
