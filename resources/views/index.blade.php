  ...
  <body class="leading-normal tracking-normal text-white gradient" style="font-family: 'Source Sans Pro', sans-serif;">
      ...
      <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
        ...
        <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden mt-2 lg:mt-0 bg-white lg:bg-transparent text-black p-4 lg:p-0 z-20" id="nav-content">
          <ul class="list-reset lg:flex justify-end flex-1 items-center">
            ...
            <li class="mr-3">
              <a class="toggleColour inline-block text-white {{ Request::is('/angket') ? 'font-bold' : '' }} no-underline hover:text-gray-800 hover:text-underline py-2 px-4" onclick="scrollToAcaras()">Angket</a>
            </li>
          </ul>
          @if (auth()->check())
    ...
    <div class="pt-24">
      <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
        ...
        <div class="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
          <p class="uppercase tracking-loose w-full">Selamat Datang di Expo 2024</p>
    ...
    <section class="bg-white border-b py-8">
      <div class="container max-w-5xl mx-auto m-8">
        <h2 class="w-full my-2 text-5xl font-bold leading-tight text-center text-gray-800">
          Kami mengundang Anda untuk berpartisipasi dan berinteraksi dengan sesama pengunjung.
        </h2>
        ...
        <div class="flex flex-wrap">
          <div class="w-5/6 sm:w-1/2 p-6">
            <h3 class="text-3xl text-gray-800 font-bold leading-none mb-3">
              Dengar langsung dari peserta sebelumnya dalam testimoni mereka."
            </h3>
            <p class="text-gray-600 mb-8">
              Baca ulasan positif dari mereka yang telah menghadiri expo kami sebelumnya.
              <br />
              <br />
        ...
        <div class="flex flex-wrap flex-col-reverse sm:flex-row">
          ...
          <div class="w-full sm:w-1/2 p-6 mt-6">
            <div class="align-middle">
              <h3 class="text-3xl text-gray-800 font-bold leading-none mb-3">
                Ikuti kami di media sosial untuk pembaruan langsung dan konten eksklusif.
              </h3>
              <p class="text-gray-600 mb-8">
                Kunjungi stan informasi untuk pertanyaan atau panduan tambahan.
                <br />
                <br />
                Images from:
              ...
              <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
                  <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
                      <a href="#" class="flex flex-wrap no-underline hover:no-underline">
                        <img src="{{ $acara->photo }}" alt="{{ $acara->nama_acara }}" class="w-full mb-4">
      
                          <h2 class="w-full text-gray-600 font-extrabold text-xs md:text-sm px-6 mb-4">
                              {{ $acara->nama_acara }}
                          </h2>
                  ...
                  <div class="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-6">
                      <div class="flex items-center justify-center"> <!-- Center the button -->
                          <a href="{{ route('angket.form', $acara->id) }}" class="mx-auto lg:mx-0 hover:underline gradient text-white font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
                              Action
                          </a>
                      </div>
                  </div>
    ...
    <section class="container mx-auto text-center py-6 mb-12">
      ...
      <h3 class="my-4 text-3xl leading-tight">
        Hubungi kami jika menemukan kendala.
      </h3>
